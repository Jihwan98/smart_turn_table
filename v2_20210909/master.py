...
if __name__ == '__main__' :
    try:    
        ...
        tc = Thread(target=tc_thread, args=(TC_audio2TC, angle_list, angle_ent, device_mode,email_deq,loading,rainbow,))
        ssl = Thread(target=ssl_thread, args=(SSL_audio2SSL, angle_list, angle_ent,))
