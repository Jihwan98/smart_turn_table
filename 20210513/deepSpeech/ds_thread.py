...
def deepSpeech_thread(frames, tods_deq, angle_deq, motor_ent):
    ...
    Args:
        frames(Audio): generator which generate raw audio data 
        tods_dep(deque): deque to receive a new trigger word from get_command thread
        angle_deq(deque): deque to receive angle from sLocalization thread
