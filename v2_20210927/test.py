...
if __name__ == '__main__' :
    try:    
        ...
        audio_thread = Thread(target=audio_thread, args=(audio2SSL_audio,audio2TC_audio, loading,rainbow,))
        ...
        tc = Thread(target=tc_thread, args=(TC_audio2TC, angle_list, train_ent, device_mode,email_deq,loading,rainbow,))
        ssl = Thread(target=ssl_thread, args=(SSL_audio2SSL, angle_list, train_ent,))
