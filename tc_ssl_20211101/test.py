...
if __name__ == '__main__' :
    try:    
        ...
        trigword_deq = collections.deque()#
        ...
        get_command_thread = Thread(target=get_command_thread, args=(internet_ent,trigword_deq, email_deq, device_mode,))
        ...
        tc = Thread(target=tc_thread, args=(TC_audio2TC, device_mode,email_deq,loading,rainbow,trigword_deq,))
